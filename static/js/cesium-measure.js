    ...
    _.prototype = {
      ...
      drawTrianglesMeasureGraphics: function (options = {}) {
        ...
        if (this._viewer && options) {
          ...
          var _tempLineEntity = new Cesium.Entity()
          var _tempLineEntity2 = new Cesium.Entity()
          var _positions = []
          var _tempPoints = []
          var _tempPoints2 = []
          var $this = this
          ...
          _trianglesEntity.label = {
            text: new Cesium.CallbackProperty(function () {
              return '直线距离:' + $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_positions)) + '米'
            }, false),
            show: true,
            showBackground: true,
            // font: '14px monospace',
